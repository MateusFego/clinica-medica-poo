...
public class Prontuario extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(imepac.projeto.frontend.Prontuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new imepac.projeto.frontend.Prontuario().setVisible(true);
            }
        });
    }
